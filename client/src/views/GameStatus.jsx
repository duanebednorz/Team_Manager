...
const GameStatus = (props) => {
  ...
  //   ********************************************************
    ...
    const handleClick = ()=>{
        setLinkStyle({backgroundColor: 'red'})
    }
    return (
        <div>
              ...
              return (
                <tr key={i}>
                  ...
                  <td>
                    ...
                    <button className ="btn btn-primary mx-1">Playing</button>
                    <button className ="btn btn-primary mx-1" onClick ={handleClick} style ={linkStyle}>Not Playing</button>
                    {/* <button 
                        onClick={handleClick} 
